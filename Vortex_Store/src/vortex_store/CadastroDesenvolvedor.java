...
public class CadastroDesenvolvedor extends javax.swing.JFrame {
    ...
    jPanel7.setBorder(defaultBorder);//Nome
    jPanel10.setBorder(defaultBorder);//Senha
    jPanel8.setBorder(defaultBorder);//Email
    jPanel11.setBorder(defaultBorder);//CPF
}
    ...
    private void initComponents() {
        ...
        erroCPF.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        erroCPF.setForeground(new java.awt.Color(231, 53, 65));
        erroCPF.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
     ...
     String email = txtEmail.getText();
       ...
       if (email.trim().isEmpty() || senha.trim().isEmpty() || nome.trim().isEmpty() || cpf.trim().isEmpty()) {
        Border redBorder = BorderFactory.createLineBorder(borderColor, 2, true);
        if (email.trim().isEmpty()) {
            jPanel8.setBorder(redBorder); // Destaca o campo do email
            erroEmail.setText("Preencha o email!");
        ...
        if (nome.trim().isEmpty()) {
            jPanel7.setBorder(redBorder); // Destaca o campo da senha
        ...
        if (cpf.trim().isEmpty()) {
            jPanel11.setBorder(redBorder); // Destaca o campo da senha
    ...
    private void button4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button4ActionPerformed
        String email = txtEmail.getText();
        String nomeDev = txtNome.getText();
        String senha= txtSenha.getText();
        String cpf = txtCPF.getText();
