package com.raven.swing.combobox;
...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(45, 45, 48));
             
            }

            @Override
            public void focusLost(FocusEvent fe) {
                border.setColor(new Color(206, 212, 218));// Não sei também
            }
        });
        ...
        txt.setSelectionColor(new Color(54, 189, 248));//Não sei
        txt.setBorder(new EmptyBorder(0, 4, 0, 4));
        comboBox.setBackground(Color.WHITE);// não sei, não faz diferença
        ...
        return new ListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean bln, boolean bln1) {
                ...
                if (bln) {
                    ...
                    label.setBackground(new Color(27, 30, 43));//Cor da seleção
                    label.setForeground(new Color(143,101,189));// Cor do texto selecionado
                }else {
                label.setOpaque(true);
                label.setBackground(new Color(45, 45, 48)); // Cor de fundo do item não selecionado
                label.setForeground(Color.WHITE); // Cor do texto dos itens não selecionados
            }
                return label;
            }
        };
    ...
    private class ComboSuggestionPopup extends BasicComboPopup {
        ...
        protected JScrollPane createScroller() {
            ...
            list.setBackground(new Color(50,53,60)); //Cor das seleçoes da lista
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(128, 189, 255); //Não sei
        private Color color = new Color(206, 212, 218); //Não seiiiiiiiii
