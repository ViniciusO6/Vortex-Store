...
public class ComponentResizer1 extends MouseAdapter {
    ...
    public ComponentResizer1() {
        this(new Insets(5, 5, 5, 5), new Dimension(1, 1));
    }

    public ComponentResizer1(Component... components) {
        this(new Insets(5, 5, 5, 5), new Dimension(1, 1), components);
    }

    public ComponentResizer1(Insets dragInsets, Component... components) {
        this(dragInsets, new Dimension(1, 1), components);
    }

    public ComponentResizer1(Insets dragInsets, Dimension snapSize, Component... components) {
